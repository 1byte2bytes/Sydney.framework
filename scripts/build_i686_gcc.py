...
buildlib.build_configure("gcc-7.3.0.tar.gz", "--with-isl={} --with-cloog={} --with-gmp={} --with-mpfr={} --with-mpc={} --disable-nls --enable-languages=c,c++ --without-headers --target=i686-elf"
